		...
		if( $userbooksPath != '' )
		{
			...
			if( $this->registry->getObject('db')->numRows() == 1 )
			{
				...
				//}
                                                                                                ...
                                                                                                $this->user_book_id = $data['user_book_id'];
                                                                                                $this->bcid = $data['bcid'];
                                                                                                $this->sell_flag = $data['sell_flag'];
                                                                                                $this->exchange_flag = $data['exchange_flag'];
                                                                                                $this->highlight_flag = $data['highlight_flag'];
                                                                                                $this->price = $data['price'];
                                                                                                $this->remarks = $data['remarks'];
                                                                                                $this->pict1 = $data['pict1'];
                                                                                                $this->pict2 = $data['pict2'];
                                                                                                $this->pict3 = $data['pict3'];
